...
class PrimeiroAcessoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            */
            ...
            ->add('lattes', UrlType::class, [
                'label' => 'URL do Currículo Lattes',
                'required' => false,
                'attr' => [
                    'data-label' => 'URL do Currículo Lattes',
                    'placeholder' => 'https://lattes.cnpq.br/010101010010xlyu3',
                    'data-msg-minlength' => 'Por favor, digite a url do lattes',
                ],
            ])
            ->add('escolaridade', ChoiceType::class, [
                'label' => 'Nível de escolaridade',
                'choices' => $this->getMaiorFormacao(),
            ])
    ...
    private function getMaiorFormacao()
    {
        return [
            '' => '',
