...
(function ($) {
    ...
    $.loader = {
        tmpl: '<div class="loading_wrp"><div class="loading ${Class}"><i class="fa  fa-3x fa-spinner fa-pulse fa-3x fa-fw "></i><span>${Title}</span></div></div>',
        open: function (arg) {
...
var intervalID = window.setInterval(reconfigurarModals, 500);

function reconfigurarModals() {
