...
(function($) {
	...
	var captureImage = function () {
		...
		var divThumbprev = document.createElement("div");
		divItem.className = "isotope-item  col-sm-12 col-md-3 col-lg-2";
		img.onclick = function () {
			responsiveClick(this);
		};
		divThumbnail.className = "thumbnail";
		divThumbprev.className = "thumb-preview";
		$output.prepend($(divItem).prepend($(divThumbnail).prepend($(divThumbprev).prepend(img))));
	};
